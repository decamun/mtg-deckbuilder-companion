...
function ContextMenuShortcut({
  ...
  return (
    <span
      ...
      className={cn(
        "ml-auto text-xs tracking-widest text-muted-foreground group-hover/context-menu-item:text-accent-foreground group-focus/context-menu-item:text-accent-foreground",
        className
      )}
      {...props}
    />
