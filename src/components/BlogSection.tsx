...
export function BlogSection() {
  ...
  return (
    <div className="mx-auto w-full max-w-2xl flex-1 px-4 py-12">
      ...
      {listMode === "full" && (
        <div className="sticky top-below-nav z-40 -mx-4 mb-8 border-b border-border/70 bg-background/90 px-4 py-2.5 backdrop-blur-md supports-backdrop-filter:bg-background/75">
