...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center p-4 selection:bg-primary/30">
      <div className="w-full max-w-md">
        <Card className="border-border bg-card/50 shadow-2xl shadow-black/20 backdrop-blur-xl">
          {mode === "auth" ? (
            <>
              <CardHeader>
